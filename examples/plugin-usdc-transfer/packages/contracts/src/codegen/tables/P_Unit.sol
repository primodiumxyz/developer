...
library P_Unit {
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(attack, defense, speed, cargo, trainingTime);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (uint256 attack, uint256 defense, uint256 speed, uint256 cargo, uint256 trainingTime) {
  ...
  function decode(
    ...
    (_table.attack, _table.defense, _table.speed, _table.cargo, _table.trainingTime) = decodeStatic(_staticData);
  }
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(attack, defense, speed, cargo, trainingTime);
  }
