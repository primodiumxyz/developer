...
```js copy filename="@primodiumxyz/contracts/mud.config.ts#L47-L59" showLineNumbers
{
  // ...
  P_GameConfig: {
    key: [],
...
```js copy filename="@primodiumxyz/contracts/mud.config.ts#L79-L82" showLineNumbers
{
  Position: {
    key: ["entity"],
    schema: { 
