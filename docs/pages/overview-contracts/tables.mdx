...
The following json string in [`mud.config.ts`](https://github.com/primodiumxyz/contracts/blob/main/mud.config.ts#L85-L97) encodes a table that stores key game configuration named `P_GameConfig`.

```js copy filename="@primodiumxyz/contracts/mud.config.ts#L85-L97" showLineNumbers
{
  // ...
  P_GameConfig: {
    keySchema: {},
