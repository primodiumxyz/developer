...
In the open MUD standard, hooks can react to both system calls and tables. Tables hooks are used throughout Primodium contracts, unlike system hooks are replaced with [subsystems](./subsystems.mdx) and modifiers.
