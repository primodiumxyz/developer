...
able to render the [Phaser](https://phaser.io/) game, with a
[React](https://react.dev/) UI on top of it, interact with the contracts, and
sync the state with the indexer database (or RPC updates).
...
This package uses
[the core package](https://github.com/primodiumxyz/primodium/tree/main/packages/core)
for all the logic,
[the engine package](https://github.com/primodiumxyz/primodium/tree/main/packages/engine)
for the Phaser scene management (api, creating scenes, rendering chunks),
[the game package](https://github.com/primodiumxyz/primodium/tree/main/packages/game)
for Phaser, and
[the assets package](https://github.com/primodiumxyz/primodium/tree/main/packages/assets)
for the assets.
