...
Primodium has a large amount of complex logic. The limitiation on smart contract size by [EIP-170](https://eips.ethereum.org/EIPS/eip-170) has blocked our ability to add key features.
