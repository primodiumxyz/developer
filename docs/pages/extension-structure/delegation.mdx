...
dependent on the delegation to remain in the future! For now this is a [footgun](../extension-footguns.mdx), but a future release will include credibly committed delegations that can only be revoked under specific conditions.
