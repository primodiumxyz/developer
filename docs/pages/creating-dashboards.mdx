...
For this guide, we will use _Apollo Studio_ to read Primodium data from our GraphQL endpoint.
...
- [react-client-lite](../react-client-lite.mdx): Minimal setup to start creating read-only clients with the Primodium GraphQL endpoint.
