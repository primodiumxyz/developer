...
See
[here](https://github.com/primodiumxyz/primodium/tree/main/examples/template)
for a world extension template and refer to the following sections for more
information on world extensions.
