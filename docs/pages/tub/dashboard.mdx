...
The **Primodium DEX Dashboard** is a React-based dashboard for visualizing the
data indexed in a database and accessed via the
[Primodium DEX GraphQL client](../dex-indexer/graphql.mdx). It uses
[shadcn/ui](https://ui.shadcn.com/) for styling and
