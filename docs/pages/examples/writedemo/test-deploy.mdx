...
The commented code can be found in [`packages/contracts/script/RegisterWriteDemoSystem.s.sol`](https://github.com/primodiumxyz/developer/tree/main/examples/WriteDemo/packages/contracts/script/RegisterWriteDemoSystem.s.sol).

## Code

```solidity filename="examples/WriteDemo/packages/contracts/script/RegisterWriteDemoSystem.s.sol" showLineNumbers
