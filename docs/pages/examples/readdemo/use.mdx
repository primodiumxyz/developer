...
The commented code can be found in [`packages/contracts/scripts/ReadMainBaseLevel.s.sol`](https://github.com/primodiumxyz/developer/tree/main/examples/ReadDemo/packages/contracts/script/ReadMainBaseLevel.s.sol)
...
```solidity filename="examples/ReadDemo/packages/contracts/scripts/ReadMainBaseLevel.s.sol" showLineNumbers
