...
**Primodium React Tables** is a fully fledged, strictly typed library for
generating and managing reactive tables in a
[MUD application](https://www.mud.dev), available for node and browser
environments.

Reactive Tables is open-sourced on Github
[here](https://github.com/primodiumxyz/reactive-tables). It is a fork of the
[RECS package](https://mud.dev/state-query/typescript/recs) from Lattice.
