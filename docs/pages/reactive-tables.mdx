...
**A fully fledged, strictly typed library for generating and managing reactive
tables in a MUD application, available for node and browser environments.**

_This is a fork of the
[RECS package](https://mud.dev/state-query/typescript/recs) from Lattice._
...
The package encompasses a wide range of functionnalities, from creating a tables
...
functionnalities, with a more convenient and explicit API, and clearer
