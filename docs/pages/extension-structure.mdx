...
All members:
1. Necessary people give bounded delegation to the systems that require it (don't forget delegation [footguns](./extension-footguns.mdx))
...
Admin:
1. Complete the [necessary steps](./extension-structure#registering-all-world-extensions) to register your namespace, tables, systems, and functions
    - Make the necessary systems publicly accessible
...
2. Necessary people give bounded delegation to the systems that require it (don't forget delegation [footguns](./extension-footguns.mdx))
3. Members execute alliance systems via system calls

### Opt-in Physics 

E.g. new ships, resources, etc.

Likely not yet ready due to the lack of [credibly committed delegations](./extension-footguns.mdx).
