...
Use the player account to see your wallet address, delegate address and private key, and world address. It also includes information about the [wagmi](https://github.com/wevm/wagmi) client use for connecting external wallets in the client.
