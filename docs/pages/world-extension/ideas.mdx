...
The following are world extension ideas to serve as inspiration to deploy alongside existing Primodium contracts.

Some of the more sophisticated ideas may not be possible with the current state of the Primodium contracts, but they are included here to serve as inspiration for future development. Some may [rely on](./structure/delegation.mdx#revoking-practices) a `CommittedDelegationModule` MUD standard to be implemented.
...
### Deep Extensions
- `CommittedDelegationModule` to serve as a new MUD module to help implement some of the other ideas
