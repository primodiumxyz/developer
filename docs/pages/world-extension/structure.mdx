...
Building on top of the world extension structure as dictated by the MUD standard, Primodium contracts also includes optional access patterns for various forms of delegation and access control.
