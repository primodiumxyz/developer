...
Since the Primodium core contracts are not open source yet, the best way to test your world extension is to fork the Primodium live testnet using
...
7. In your test file, make sure to at minimum import the following files. See `/examples/BuildingUpgradeBountyackages/contracts/test/UpgradeBountyExtension.t.sol` for more useful imports.
