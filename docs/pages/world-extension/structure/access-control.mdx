...
Namespace Owners also have additional rights that should be used with caution. Review the MUD documentation on [access control levels](https://mud.dev/world/namespaces-access-control#access-control-levels) for more information.
