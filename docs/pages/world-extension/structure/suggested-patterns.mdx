...
See extension [examples](../examples.mdx) for an implementation of the following
patterns and further diagrams.
...
1. Complete the
   [necessary steps](../extension-structure#registering-all-world-extensions) to
