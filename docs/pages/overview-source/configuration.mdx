...
```ts filename="/contract-source/config/prototypeConfig.ts" showLineNumbers
{
  CopperMine: {
    tables: {
...
```ts filename="/contract-source/config/enums.ts" showLineNumbers
...
```ts filename="/contract-source/ts/prototypes/prototypeGenUtils.ts" showLineNumbers
