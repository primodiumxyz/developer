...
```ts filename="@primodiumxyz/contracts/ts/prototypes/prototypeGenUtils.ts#L91-L97" showLineNumbers
...
```ts filename="@primodiumxyz/contracts/config/util/blueprints.ts" showLineNumbers
