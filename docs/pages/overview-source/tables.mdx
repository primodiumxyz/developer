...
```solidity copy filename="@primodiumxyz/contracts/src/codegen/tables/AsteroidCount.sol" showLineNumbers {5}
library AsteroidCount {
  // ...
...
```solidity copy filename="/examples/building-upgrade-bounty/packages/contracts/src/libraries/LibHelpers.sol" showLineNumbers {1,4}
...
```solidity copy filename="/examples/building-upgrade-bounty/packages/contracts/src/libraries/LibHelpers.sol" showLineNumbers {1,7}
