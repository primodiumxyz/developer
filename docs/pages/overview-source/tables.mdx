...
```solidity filename="@primodiumxyz/contracts/src/codegen/tables/AsteroidCount.sol" showLineNumbers {4}
...
```solidity filename="@primodiumxyz/contracts/src/codegen/tables/AsteroidCount.sol" showLineNumbers {5}
library AsteroidCount {
  // ...
