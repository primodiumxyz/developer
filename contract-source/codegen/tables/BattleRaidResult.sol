...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_OFFCHAIN_TABLE, bytes14(""), bytes16("BattleRaidResult")))
);
ResourceId constant BattleRaidResultTableId = _tableId;
...
library BattleRaidResult {
  ...
  function set(
    ...
    PackedCounter _encodedLengths = encodeLengths(resourcesAtStart, resourcesAtEnd);
   ...
   */
  function set(bytes32 battleId, bytes32 participantEntity, BattleRaidResultData memory _table) internal {
    bytes memory _staticData;
    PackedCounter _encodedLengths = encodeLengths(_table.resourcesAtStart, _table.resourcesAtEnd);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 battleId, bytes32 participantEntity, BattleRaidResultData memory _table) internal {
    bytes memory _staticData;
    PackedCounter _encodedLengths = encodeLengths(_table.resourcesAtStart, _table.resourcesAtEnd);
    bytes memory _dynamicData = encodeDynamic(_table.resourcesAtStart, _table.resourcesAtEnd);
  ...
  function encodeLengths(
    ...
    unchecked {
      _encodedLengths = PackedCounterLib.pack(resourcesAtStart.length * 32, resourcesAtEnd.length * 32);
    }
  }
