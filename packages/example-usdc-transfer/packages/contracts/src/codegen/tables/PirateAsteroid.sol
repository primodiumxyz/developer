...
library PirateAsteroid {
  ...
  function setPrototype(bytes32 entity, bytes32 prototype) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((prototype)), _fieldLayout);
  }
  ...
  function _setPrototype(bytes32 entity, bytes32 prototype) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((prototype)), _fieldLayout);
  }
   ...
   */
  function set(bytes32 entity, bytes32 playerEntity, bytes32 prototype) internal {
    bytes memory _staticData = encodeStatic(playerEntity, prototype);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 entity, bytes32 playerEntity, bytes32 prototype) internal {
    bytes memory _staticData = encodeStatic(playerEntity, prototype);
  ...
  function set(bytes32 entity, PirateAsteroidData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.playerEntity, _table.prototype);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (bytes32 playerEntity, bytes32 prototype) {
    playerEntity = (Bytes.slice32(_blob, 0));

    prototype = (Bytes.slice32(_blob, 32));
  }
  ...
  function decode(
    ...
    (_table.playerEntity, _table.prototype) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(bytes32 playerEntity, bytes32 prototype) internal pure returns (bytes memory) {
    return abi.encodePacked(playerEntity, prototype);
  }
